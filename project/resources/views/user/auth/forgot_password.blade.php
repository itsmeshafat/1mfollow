                ...
                <div class="accounts-left">
                    <div class="accounts-left-content">
                        <div class="section-header">
                            <h3 class="section-header__title mt-0">@lang('Provide your email address')</h3>
                        </div>
                        <form class="row gy-4" action="" method="post"> 
                            @csrf
                            <div class="col-sm-12">
                                <label for="username" class="form-label">@langg('Email')</label>
