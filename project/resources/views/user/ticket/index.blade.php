                   ...
                   <div class="card-body">
                    <div class="chatbox__list__wrapper">
                        <div class="d-flex justify-content-between py-4 border-bottom border--dark">
                            <h5 class=""><a href="javascript:void(0)">@langg('Tickets')</a></h5>
                            <button class="btn btn-primary shadow-none" data-bs-toggle="modal" data-bs-target="#modelId"><i class="fas fa-plus me-2"></i> @langg('Opent a Ticket')</button>
                        </div>
                                ...
                                <div class="chat__msg">
                                    <div class="chat__msg-header py-2 border-bottom">
                                        <div class="post__creator align-items-center">
                                            ...
                                            <div class="post__creator-content">
                                                <h4 class="name d-inline-block">@langg('Ticket Number : #'){{request('messages')}}</h4>
                                            </div>
                                            ...
                                            @if (request('messages'))
                                                @forelse ($messages as $item)
                                                    ...
                                                    <li class="outgoing__msg">
                                                        <div class="msg__item">
                                                            <div class="post__creator ">
                                                                <div class="post__creator-content">
                                                                    <p class="out__msg">{{translate($item->message)}}</p>
                                                                    @if ($item->file)
                                                ...
                                                <li class="incoming__msg">
                                                    <div class="msg__item">
                                                        <div class="post__creator">
                                                            <div class="post__creator-content">
                                                                <h4 class="text-center">@langg('No messages yet!!')</h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                ...
                @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">@langg('Open a ticket')</h5> 
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="mb-2">@langg('Subject')</label>
