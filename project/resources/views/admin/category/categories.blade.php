               ...
               @forelse ($categories as $item)
                   <tr>
                        ...
                        <td data-label="@langg('Action')" class="text-right">
                           <a href="javascript:void()" class="btn btn-primary approve btn-sm edit" data-route="{{route('admin.update.category',$item->id)}}" data-item="{{$item}}" data-toggle="tooltip" title="@langg('Edit')"><i class="fas fa-edit"></i></a>
