        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="geniusformUpdate" action="{{route('admin.gs.update')}}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="form-group row mb-5">
                    <label for="tawk_id" class="col-sm-3 col-form-label">{{ __('Google Recaptcha Key') }}</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row mb-5">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="recaptcha_secret" value="{{$gs->recaptcha_secret}}" placeholder="{{ __('Google Recaptcha Secret') }}">
                    </div>
                  </div>
                  <div class="form-group row mb-5">
                    ...
                    <div class="col-sm-9">
                        ...
                        <code class="mt-2">@langg('Keep this field blank if you wants to allow any email domain.')</code>
                    </div>
                  </div>
