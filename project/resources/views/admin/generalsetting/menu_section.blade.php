                ...
                <div class="col-lg-12">
                   <ul class="list-group">
                      ...
                      <li class="list-group-item d-flex justify-content-between">
                         ...
                         <a data-title="{{ $pg->title }}" data-dropdown="no" data-href="{{"pages/".$pg->slug}}"  data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                      </li>
