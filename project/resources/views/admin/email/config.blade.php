...
<div class="row justify-content-center mt-3">
    <div class="col-lg-12">
       <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
             ...
             <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#testMail">@langg('Test Mail')</button>
          </div>
          <div class="card-body">
 ...
 <!-- Modal -->
 <div class="modal fade" id="testMail" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <form action="{{route('admin.send.test.email')}}" method="POST">
         @csrf
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title">@langg('Send Test Email')</h5>
            ...
            <div class="modal-footer">
               ...
               <button type="submit" class="btn btn-primary">@langg('Send')</button>
            </div>
         </div>
      </form>
   </div>
