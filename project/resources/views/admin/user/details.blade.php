                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-lg-12 col-md-6">
                            <a href="javascript:void(0)" class="wallet"   data-toggle="tooltip" title="@lang('Click to Add or Subtract Balance')">
                                <div class="card card-statistic-1 bg-sec">
                                    ...
                                    <div class="card-wrap">
                                        <div class="card-header ">
                                            <h4 class="text-dark">@lang('Balance') <small>(@langg('Click to modify'))</small></h4>
                                        </div>
                                        <div class="card-body">
                                            {{round($user->balance,3)}} {{$gs->curr_code}}
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-xxl-6 col-lg-12 col-md-6">
                            <div class="card card-statistic-1 bg-sec">
                                ...
                                <div class="card-wrap">
                                    <div class="card-header ">
                                        <h4 class="text-dark">@lang('Total Order')</h4>
                                    </div>
                                    <div class="card-body">
                                        {{$user->orders->count()}}
                                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between">@langg('Total Deposited') <span>{{round($data['totalDeposit'],2)}} {{$gs->curr_code}}</span></li>
                     
                        @if (access('user login'))
                        <li class="list-group-item d-flex justify-content-between">@langg('Login to User') <span><a target="_blank" href="{{route('admin.user.login',$user->id)}}" class="btn btn-dark">@langg('Login')</a></span></li>
                        @endif

                        <li class="list-group-item d-flex justify-content-between">@langg('User Login Info') <span><a href="{{route('admin.user.login.info',$user->id)}}" class="btn btn-dark">@langg('View')</a></span></li>
                    </ul>
                </div>
            </div>
        </div>
